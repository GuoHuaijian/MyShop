                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/content/category/save"
                                   method="post" modelAttribute="tbContentCategory">
                            <form:hidden path="id"/>
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="parentName" class="form-control" placeholder="请选择" readonly="true"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="sortOrder" class="form-control required digits"
                                                    placeholder="分类排序"/>
                                    </div>
                                </div>
                            </div>
